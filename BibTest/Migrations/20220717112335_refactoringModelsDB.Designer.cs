...
namespace BibTest.Migrations
{
    ...
    [Migration("20220717112335_refactoringModelsDB")]
    partial class refactoringModelsDB
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BibTest.DAL.Models.LoanOfBook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BibTest.DAL.Models.LoanOfBook", b =>
                {
                    ...
                    b.HasOne("BibTest.DAL.Models.User", "User")
                        .WithMany()
